...
void screen31UP(){  
  if (setting_item > 1) {
    ...
    switch (setting_item) {
      ...
      gfx2->print("mm/min");  
      gfx2->setCursor(5, 56);
      gfx2->println("Light-Off Delay");
      gfx2->setCursor(5, 74);
      gfx2->print(Light_Off_Delay);
      gfx2->print(" s");
      gfx2->drawRoundRect(0, 41, 160, 39, 3, BLACK);
      gfx2->drawRoundRect(0, 0, 160, 39, 3, WHITE); 
        break;   
      ...
      gfx2->print(" s");  
      gfx2->setCursor(5, 56);
      gfx2->println("UV Power");
      gfx2->setCursor(5, 74);
      gfx2->print(UV_Power_Percent);
      gfx2->print(" %");
      gfx2->drawRoundRect(0, 41, 160, 39, 3, BLACK);
      gfx2->drawRoundRect(0, 0, 160, 39, 3, WHITE); 
        break;
      ...
      gfx2->print(" %");  
      gfx2->setCursor(5, 56);
      gfx2->println("Override GCODE");
      gfx2->setCursor(5, 74);
      if (Override_GCODE) gfx2->print("ON"); else gfx2->print("OFF");
      gfx2->drawRoundRect(0, 41, 160, 39, 3, BLACK);
      gfx2->drawRoundRect(0, 0, 160, 39, 3, WHITE); 
        break;
      case 14:
